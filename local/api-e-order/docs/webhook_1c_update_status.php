<div class="api-doc-container">
    ...
    <ul class="list-disc pl-5 space-y-2">
        ...
        <li><strong>Нет изменений:</strong> Если статус совпадает и дополнительные поля не переданы (или пусты), система возвращает ошибку 400.</li>
    </ul>
    ...
    <table class="param-table">
        ...
        <tr>
            ...
            <td>string</td>
            <td><span class="required">Да</span></td>
            <td>Тип объекта. Строго <code>"STATUS"</code>.</td>
        </tr>
        <tr>
...
--data '{
    ...
    <p>Возвращается при успешном обновлении. Ответ содержит ID обновленного заказа.</p>
...
{
    "status": "error",
    "message": "Для заказа №72525161 статус '201' уже установлен, и нет дополнительных данных для обновления.",
    "type": null
}
</pre>
